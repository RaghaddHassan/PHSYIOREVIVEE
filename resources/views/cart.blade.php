            ...
            <div class="site-blocks-table">
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    <td  >
                      <img src="{{asset('front/images/products_images/1.jpg')}}" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">Wrist Exercises </h2>
                    </td>
                    <td>$55.00</td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <img src="{{asset('front/images/products_images/2.jpg')}}" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black">Band Resistance </h2>
                    </td>
                    <td>$49.00</td>
                    <td>
                      <div class="input-group mb-3" style="max-width: 120px;">
          ...
          <div class="col-md-6 ">
            <div class="row justify-content-end">
              <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <button class="btn  btn-md " onclick="window.location='payment'">Proceed To
                      Checkout</button>
                  </div>
                </div>
              </div>
