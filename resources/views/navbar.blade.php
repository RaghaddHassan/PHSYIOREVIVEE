        ...
        @enderror
                ...
                <div class="col-xl-6">
                    <select class="form-select wide" id="default-select" name="doctor"class=" @error('doctor')is-invalid @enderror" >
                        ...
                        <option value="Mirazul Alom">Asser Ehab</option>
                        <option value="Monzul Alom">Nouran Ahmed</option>
                        <option value="Azizul Isalm">Hassan Samir</option>
                    </select>
                    @error('doctor')
        <span class="text-danger">{{$message}}
        @enderror
                ...
                <div class="col-xl-6">
                    <select class="form-select wide" id="default-select" name="trainer"class=" @error('trainer')is-invalid @enderror" >
                        <option value="" disabled selected>Select Trainer</option>
                        <option value="Mirazul Alom">Youssef Hassan</option>
                        <option value="Monzul Alom">Mahmoud Waleed</option>
                        <option value="Azizul Isalm">Noha Hany</option>
                    </select>
                    @error('trainer')
        <span class="text-danger">{{$message}}
        @enderror
