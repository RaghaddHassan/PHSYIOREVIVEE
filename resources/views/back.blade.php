...
<head>
    ...
    <link rel="stylesheet" href="{{asset('Sections/css/all.css')}}">
     <link rel="stylesheet" href="{{asset('Sections/css/back.css')}}">
...
<div id="over-view">
 ...
 <p>
   <br>
    ...
    If a nerve in this area is pinched, irritated, or injured, you also may feel pain in other places where the nerve travels, including your arms, legs, chest, and belly.
    <br>
    <b>
    What Causes Back Pain?
    </b>
    “The most common causes of occasional back pain include overuse, strain, or injury to the muscles, ligaments, and discs that support your spine
    ...
    Additionally, if you’re spending hours at a computer each day — whether at the workplace or at home — poor posture and ergonomics
    (how your desk is set up) can lead to chronic back pain.
</p>

</div>
<div id="prevention" >
    <h1>Prevenetion</h1>
    <h5>Back pain prevention</h5>
    <p>
