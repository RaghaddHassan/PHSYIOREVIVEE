            ...
            <h2>Our Experts Trainers</h2>
				...
				<div class="row no-gutters">
					<div class="col-md-4 col-lg ftco-animate d-flex">
						<div class="staff bg-primary">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url({{asset('front/images/trainers/staff-1.jpg);')}}"></div>
							</div>
					...
					<div class="col-md-4 col-lg ftco-animate d-flex">
						<div class="staff bg-primary">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url({{asset('front/images/trainers/staff-2.jpg);')}}"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>Mohamed Ahmed</h3>
					...
					<div class="col-md-4 col-lg ftco-animate d-flex">
						<div class="staff bg-primary">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url({{asset('front/images/trainers/staff-3.jpg);')}}"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>Eslam Amr</h3>
								<span class="position mb-2">trainer</span>
					...
					<div class="col-md-4 col-lg ftco-animate d-flex">
						<div class="staff bg-primary">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url({{asset('front/images/trainers/staff-4.jpg);')}}"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>Aly Ashraf</h3>
								<span class="position mb-2">Trainer</span>
					...
					<div class="col-md-4 col-lg ftco-animate d-flex">
						<div class="staff bg-primary">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url({{asset('front/images/trainers/staff-5.jpg);')}}"></div>
							</div>
							<div class="text pt-3 px-3 pb-4 text-center">
								<h3>Asser Ehab</h3>
								<span class="position mb-2">Trainer</span>
...
<!-- FEEDBACK -->
		...
		<section class="ftco-section ftco-no-pt ftco-no-pb" id="blog">
          ...
          <div class="col-md-3 ftco-animate">
            <div class="work img d-flex align-items-center" style="background-image: url({{asset('front/images/images/foot.jpg);')}}">
            	...
            	<div class="desc w-100 px-4 text-center pt-5 mt-5" >
	              <div class="text w-100 mb-3 mt-4" >
	              	<h2><a href="FootDocuments">Foot Pain</a></h2>
	              </div>
              </div>
            </div>
          </div>
          <div class="col-md-3 ftco-animate">
            <div class="work img d-flex align-items-center" style="background-image: url({{asset('front/images/images/work-1.jpg);')}}">
            	...
            	<div class="desc w-100 px-4 text-center pt-5 mt-5">
	              <div class="text w-100 mb-3 mt-4">
	              	<h2><a href="ArmDocuments">Arm Pain</a></h2>
	              </div>
              </div>
            </div>
          </div>
          <div class="col-md-3 ftco-animate">
            <div class="work img d-flex align-items-center" style="background-image: url({{asset('front/images/images/shoulder.jpg);')}}">
            	<a href="{{asset('front/images/images/work-3.jpg')}}" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="fa-solid fa-up-right-and-down-left-from-center text-light"></span>
	    				</a>
            	<div class="desc w-100 px-4 text-center pt-5 mt-5">
	              <div class="text w-100 mb-3 mt-4">
	              	<h2><a href="ShoulderDocuments">Shoulder Pain</a></h2>
	              </div>
              </div>
            </div>
          </div>
          <div class="col-md-3 ftco-animate">
            <div class="work img d-flex align-items-center" style="background-image: url({{asset('front/images/images/work-4.jpg);')}}">
            	...
            	<div class="desc w-100 px-4 text-center pt-5 mt-5">
	              <div class="text w-100 mb-3 mt-4">
	              	<h2><a href="BackDocuments">Back Pain</a></h2>
	              </div>
              </div>
            </div>
          </div>
