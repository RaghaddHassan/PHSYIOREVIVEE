...
<!-- BANNER starts here -->
   ...
   ?>
    ...
    <!-- @foreach($offers as $offer)
        ...
        <div class="product-grid" >
            ...
            <div class="product-image" >
                <a href="#" class="image" name="photo">
                    <img src="{{asset('front/images/products_images/8.jpg')}} ">
                </a>
                <span class="product-discount-label">-23%</span>
                <ul class="product-links">
                    <li><a href="#"><i class="fa-solid fa-cart-shopping"></i></a></li>
            ...
            <div class="product-content">
                <h3 class="title" name="name"><a href="#">Mat</a></h3>
                <div class="price" name="price">$53.55 <span>$68.88</span></div>
            </div>
        </div>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="product-grid" >
            ...
            <div class="product-image">
                <a href="#" class="image" name="photo">
                    <img src="{{asset('front/images/products_images/1.jpg')}}">
                </a>
                <span class="product-discount-label">-23%</span>
                <ul class="product-links">
                    <li><a href="#"><i class="fa-solid fa-cart-shopping"></i></a></li>
            ...
            <div class="product-content">
                <h3 class="title" name="name"><a href="#">Wrist exercises</a></h3>
                <div class="price" name="price">$80.00 <span>$70.00</span></div>
            </div>
        </div>
    ...
    <div class="col-md-3 col-sm-6" >
      <div class="product-grid" >
          ...
          <div class="product-image">
              <a href="#" class="image" name="photo">
                  <img src="{{asset('front/images/products_images/2.jpg')}}">
              </a>
              <span class="product-discount-label">-23%</span>
              <ul class="product-links">
                  <li><a href="#"><i class="fa-solid fa-cart-shopping"></i></a></li>
          ...
          <div class="product-content">
              <h3 class="title" name="name"><a href="#">band resistance</a></h3>
              <div class="price" name="price">$120.50 <span>$100.00</span></div>
          </div>
      </div>
  ...
  <div class="col-md-3 col-sm-6" >
    ...
    <div class="product-grid" >
        ...
        <div class="product-image">
            <a href="#" class="image" name="photo">
                <img src="{{asset('front/images/products_images/3.jpg')}}">
            </a>
            <span class="product-discount-label">-23%</span>
            <ul class="product-links">
                <li><a href="#"><i class="fa-solid fa-cart-shopping"></i></a></li>
        ...
        <div class="product-content">
            <h3 class="title" name="name"><a href="#">Hand gripping</a></h3>
            <div class="price" name="price">$40.50 <span>$35.88</span></div>
        </div>
    </div>
      ...
      <div class="col-md-3 col-sm-6">
        <div class="product-grid" >
            <div class="product-image">
                <a href="#" class="image" name="photo">
                    <img src="{{asset('front/images/products_images/4.jpg')}}">
                </a>
                <ul class="product-links">
                    <li><a href="#"><i class="fa-solid fa-cart-shopping"></i></a></li>
                    <li><a href="#"><i class="fa fa-heart"></i></a></li>
            ...
            <div class="product-content">
                <h3 class="title" name="name"><a href="#">Skipping rope</a></h3>
                <div class="price" name="price">$90.50</div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3 col-sm-6" >
      <div class="product-grid" >
          <div class="product-image">
              <a href="#" class="image" name="photo">
                  <img src="{{asset('front/images/products_images/5.jpg')}}">
              </a>
              <ul class="product-links">
                  <li><a href="#"><i class="fa-solid fa-cart-shopping"></i></a></li>
                  <li><a href="#"><i class="fa fa-heart"></i></a></li>
          ...
          <div class="product-content">
              <h3 class="title" name="name"><a href="#">Steper</a></h3>
              <div class="price" name="price">$60.00</div>
          </div>
      </div>
  </div>
  ...
  <div class="col-md-3 col-sm-6"  >
    <div class="product-grid" >
        <div class="product-image">
            <a href="#" class="image" name="photo">
                <img src="{{asset('front/images/products_images/10.jpg')}}">
            </a>
            <ul class="product-links">
                <li><a href="#"><i class="fa-solid fa-cart-shopping"></i></a></li>
                <li><a href="#"><i class="fa fa-heart"></i></a></li>
        ...
        <div class="product-content">
            <h3 class="title" name="name"><a href="#">Kettlebell</a></h3>
            <div class="price" name="price">$110.90</div>
        </div>
    </div>
</div>
...
<div class="col-md-3 col-sm-6" >
  <div class="product-grid">
      <div class="product-image">
          <a href="#" class="image" name="photo">
              <img src="{{asset('front/images/products_images/7.jpg')}}">
          </a>
          <ul class="product-links">
      ...
      <div class="product-content">
          <h3 class="title" name="name"><a href="#">balance ball</a></h3>
          <div class="price" name="price">$30.40</div>
      </div>
  </div>
</div>
</div>
