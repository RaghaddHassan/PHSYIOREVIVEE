...
<head>
    ...
    <!-- Template Stylesheet -->
    <link href="{{asset('front/css/trainers.css')}}" rel="stylesheet">
</head>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{asset('front/images/trainers/staff-2.jpg')}}" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{asset('front/images/trainers/staff-3.jpg')}}" alt="">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5>Marwan Amr</h5>
                            <p class="text-primary">Department</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{asset('front/images/trainers/staff-4.jpg')}}" alt="">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{asset('front/images/trainers/staff-1.jpg')}}" alt="">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5>Mahmoud Waleed</h5>
                            <p class="text-primary">Department</p>
                            <div class="team-social text-center">
                                <a class="btn btn-square" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square" href=""><i class="fab fa-twitter"></i></a>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{asset('front/images/trainers/staff-5.jpg')}}" alt="">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5>Roshdy Mohamed</h5>
                            <p class="text-primary">Department</p>
                            <div class="team-social text-center">
                                <a class="btn btn-square" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square" href=""><i class="fab fa-twitter"></i></a>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{asset('front/images/trainers/staff-6.jpg')}}" alt="">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5>Noha Hany</h5>
                            <p class="text-primary">Department</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{asset('front/images/trainers/staff-7.jpg')}}" alt="">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5>Nooh Abdelrehim</h5>
                            <p class="text-primary">Department</p>
                            <div class="team-social text-center">
                                <a class="btn btn-square" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square" href=""><i class="fab fa-twitter"></i></a>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item position-relative rounded overflow-hidden">
                        <div class="overflow-hidden">
                            <img class="img-fluid" src="{{asset('front/images/trainers/staff-8.jpg')}}" alt="">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5>Mohannad Amr</h5>
                            <p class="text-primary">Department</p>
